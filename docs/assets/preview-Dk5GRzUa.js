...
var T = (e, t, r) => (C(e, t, "access private method"), r);
import { j as M } from "./jsx-dev-runtime-CsvOyHnx.js";
import { j as Ee } from "./jsx-runtime-MMghOlKT.js";
import { b as xe } from "./preview-_Gs8hNM-.js";
import {
  w as $,
  x as h,
  E as G,
  ...
  A as Re,
  Q as Se,
} from "./QueryClientProvider-scR_tWxP.js";
import { d as Pe } from "./store-B5FxAW76.js";
import { B as qe } from "./index-CcQzjw1b.js";
import { b as Te } from "./api.esm-CqhHtwfv.js";
import { c as S, t as Me } from "./utils-B6PcESyr.js";
import { P as Ae } from "./Provider-BpjKgELG.js";
import { Q as Ie } from "./queryClient-xNnCd0wT.js";
import "./index-DGAqIW1f.js";
import "./mapValues-Dca9BJLA.js";
import "./index-CefgwqXd.js";
import "./isPlainObject-QLjWCcom.js";
import "./index-C-I6vmrZ.js";
import "./index-DrFu-skq.js";
import "./index-c1JcMxCd.js";
import "./index-CXarZTwe.js";
...
class je extends He {
  constructor(...r) {
    ...
    $(
      ...
      Ce(this.emitter, this.publicEmitter),
  ...
  listHandlers() {
    return _e(this.handlersController.currentHandlers());
  }
...
const Fe = (e) => (t) => {
  const { themes: r = [], selectedTheme: s } = xe(),
...
function tt(e) {
  return new Request(e.url, { ...e, body: et(e) });
}
var rt = (e, t) => async (r, s) => {
  const o = new Ze(r.ports[0]),
    n = s.payload.id,
    i = tt(s.payload),
    a = i.clone(),
    l = i.clone();
...
var lt = new Set([101, 103, 204, 205, 304]);
function ne(e) {
  return lt.has(e);
}
...
function V(e) {
  var t;
  return I ? Ge[e] : (t = globalThis[e]) == null ? void 0 : t.toString();
}
function P(e, t) {
  return e !== void 0 && e !== t;
}
  ...
  ie = class {
    ...
    addListener(e, t) {
      ...
      if (
        ...
        const s = new vt(this, e, this.listenerCount(e));
        console.warn(s);
      }
      return this;
    }
...
var wt = "x-interceptors-internal-request-id";
function z(e) {
  ...
  function (r, s) {
    return (async () => {
      e.events.removeAllListeners(),
        e.workerChannel.on("REQUEST", rt(e, r)),
  ...
  ue =
    ((ee = class extends Promise {
      constructor(t = null) {
        ...
        m(this, "reject");
        F(this, v, r),
          (this.resolve = R(this, v).resolve),
          (this.reject = R(this, v).reject);
      }
      get state() {
        return R(this, v).state;
      }
      get rejectionReason() {
        return R(this, v).rejectionReason;
      }
      then(t, r) {
        return T(this, L, A).call(this, super.then(t, r));
      }
      catch(t) {
        return T(this, L, A).call(this, super.catch(t));
      }
      finally(t) {
        return T(this, L, A).call(this, super.finally(t));
      }
    }),
    (v = new WeakMap()),
    (L = new WeakSet()),
...
function Dt(e, t) {
  ...
  return new Response(r, {
    status: e.status,
    statusText: e.statusText,
    headers: Ut(e.getAllResponseHeaders()),
  });
}
function Ut(e) {
  const t = new Headers(),
          ...
          methodCall: ([r, s], o) => {
            ...
            switch (r) {
              ...
              case "send": {
                const [i] = s;
                i != null &&
                  (this.requestBody = typeof i == "string" ? ot(i) : i),
                  this.request.addEventListener("load", () => {
                    if (typeof this.onResponse < "u") {
                      const c = Dt(this.request, this.request.response);
                ...
                (
                  ...
                  if (this.request.readyState < this.request.LOADING)
                    return (
                      ...
                      Bt && this.request.setRequestHeader(wt, this.requestId),
                      o()
                    );
                });
                break;
...
`);
        ...
        const s = e.body.getReader(),
          o = async () => {
            ...
            n &&
              ...
              (this.responseBuffer = It(this.responseBuffer, n)),
    ...
    get response() {
      ...
      switch (this.request.responseType) {
        case "json": {
          const e = Wt(this.responseBufferToText());
          return this.logger.info("resolved response JSON", e), e;
        }
        case "arraybuffer": {
          const e = at(this.responseBuffer);
  ...
  createWorkerContext() {
    const t = {
      ...
      supports: {
        ...
        readableStreamTransfer: Vt(),
      },
    };
    return (
      (this.startHandler = t.supports.serviceWorkerApi ? Xt(t) : Rt(t)),
      (this.stopHandler = t.supports.serviceWorkerApi ? Ot(t) : St(t)),
      t
    );
  }
  async start(t = {}) {
    return (
      ...
      (this.context.startOptions = re(Pt, t)),
...
var Jt = /\.(js|jsx|ts|tsx|mjs|woff|woff2|ttf|otf|eot)$/,
  Qt = [
    "sb-common-assets",
    "node_modules",
    "node-modules",
  ...
  Yt = (e) => !!(Jt.test(e) || Qt.some((r) => e.includes(r))),
  Zt = (e) =>
...
export { ve as Provider, Rr as default };
