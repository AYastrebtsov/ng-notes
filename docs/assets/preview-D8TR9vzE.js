...
var S = (e, t, r) => (
    I(e, t, "read from private field"), r ? r.call(e) : t.get(e)
  ),
  C = (e, t, r) => {
    if (t.has(e))
  ...
  F = (e, t, r, s) => (
    I(e, t, "write to private field"), s ? s.call(e, r) : t.set(e, r), r
  );
var T = (e, t, r) => (I(e, t, "access private method"), r);
import { j as _ } from "./jsx-dev-runtime-BETcGmrp.js";
import { j as xe } from "./jsx-runtime-B_9IJGoR.js";
import { b as Ee } from "./preview-DtKQ_rhK.js";
import {
  i as $,
  d as h,
  E as G,
...
import { m as Se } from "./store-CMG6tZte.js";
import { Q as Pe } from "./QueryClientProvider-DLasFzzO.js";
import { b as qe } from "./api.esm-CK-Pl4SF.js";
import { c as w, t as Te } from "./utils-Bgs-dzIv.js";
import { P as Ae } from "./Provider-C_7POvRj.js";
import { Q as Me } from "./queryClient-uewUazMH.js";
import "./index-BdMw_Ax9.js";
import "./mapValues-BXPElCjX.js";
import "./index-BSE0ybse.js";
import "./isPlainObject-BiZ90sqn.js";
import "./index-C-I6vmrZ.js";
import "./index-DrFu-skq.js";
import "./index-BU6WCtrf.js";
import "./query-BvtTCI56.js";
import "./mutation-B5pq8hhe.js";
function Ie(e, t) {
  const r = e.emit;
...
class He extends _e {
  constructor(...r) {
    ...
    $(
      ...
      (this.handlersController = new Ne(r)),
      (this.emitter = new G()),
...
async function te(e, t, r, s, o, n) {
  ...
  Ue(e, a), o.emit("request:match", { request: e, requestId: t });
  const l = i.data,
    c =
...
const Be = (e) => (t) => {
  ...
  return xe.jsx(e, {
    theme: o == null ? void 0 : o.themeObject,
    children: t(),
  });
};
function Fe(e) {
...
var ze = class extends Error {
  ...
  k = (e, t, ...r) => {
    if (!e) throw new ze(t, ...r);
  };
k.as = (e, t, r, ...s) => {
  if (!t) {
    const o = s.length === 0 ? r : q(r, s);
    let n;
    try {
...
var Je = async (e, t = {}, r) => {
  const s = Ke(e),
    o = await navigator.serviceWorker
      .getRegistrations()
      .then((a) => a.filter((l) => N(l, s, r)));
  !navigator.serviceWorker.controller && o.length > 0 && location.reload();
  const [n] = o;
  if (n) return n.update().then(() => [N(n, s, r), n]);
  const i = await U(async () => {
...
var tt = (e, t) => async (r, s) => {
  const o = new Ye(r.ports[0]),
    ...
    a = i.clone(),
    l = i.clone();
  Re.cache.set(i, l), e.requests.set(n, l);
  try {
...
function V(e) {
  var t;
  return M ? $e[e] : (t = globalThis[e]) == null ? void 0 : t.toString();
}
function P(e, t) {
  return e !== void 0 && e !== t;
}
...
var B = class {
  ...
  dispose() {
    ...
    if (
      (this.clearInstance(),
      e.info("global symbol deleted:", K(this.symbol)),
  ...
  function (r, s) {
    return (async () => {
      e.events.removeAllListeners(),
        ...
        e.workerChannel.on("RESPONSE", xt(e));
      const i = await Je(
          r.serviceWorker.url,
...
var v,
  ...
  ue =
    ((ee = class extends Promise {
      ...
      then(t, r) {
        return T(this, R, A).call(this, super.then(t, r));
      }
      catch(t) {
        return T(this, R, A).call(this, super.catch(t));
      }
      finally(t) {
        return T(this, R, A).call(this, super.finally(t));
      }
    }),
    (v = new WeakMap()),
    (R = new WeakSet()),
...
var fe = class extends B {
    ...
    async setup() {
      ...
      k(!e[L], 'Failed to patch the "fetch" module: already patched.'),
        (globalThis.fetch = async (t, r) => {
          var s;
          const o = le(),
            n =
              typeof t == "string" && typeof location < "u" && !At(t)
        ...
        Object.defineProperty(globalThis.fetch, L, {
          enumerable: !0,
          configurable: !0,
          value: !0,
        }),
        this.subscriptions.push(() => {
          Object.defineProperty(globalThis.fetch, L, { value: void 0 }),
            (globalThis.fetch = e),
            this.logger.info(
  ...
  Bt = class {
                ...
                i != null &&
                  ...
                  this.request.addEventListener("load", () => {
                    if (typeof this.onResponse < "u") {
                      const c = Wt(this.request, this.request.response);
                ...
                (
                  ...
                  if (this.request.readyState < this.request.LOADING)
                    return (
                      ...
                      Ut && this.request.setRequestHeader(vt, this.requestId),
                      o()
                    );
                });
                break;
    ...
    respondWith(e) {
      this.logger.info(
        ...
        x(this.request, Y, !0),
        x(this.request, "status", e.status),
        x(this.request, "statusText", e.statusText),
        x(this.request, "responseURL", this.url.href),
        ...
        const s = e.body.getReader(),
          o = async () => {
            ...
            n &&
              ...
              (this.responseBuffer = Mt(this.responseBuffer, n)),
...
function Ft({ emitter: e, logger: t }) {
...
var ye = class extends B {
    ...
    setup() {
      ...
      k(!t[L], 'Failed to patch the "XMLHttpRequest" module: already patched.'),
        (globalThis.XMLHttpRequest = Ft({
        ...
        Object.defineProperty(globalThis.XMLHttpRequest, L, {
          enumerable: !0,
          configurable: !0,
          value: !0,
        }),
...
function $t(e, t) {
  const r = new W({ name: "fallback", interceptors: [new pe(), new be()] });
  return (
...
var Vt = class extends He {
  ...
  createWorkerContext() {
    ...
    return (
      ...
      (this.stopHandler = t.supports.serviceWorkerApi ? Xt(t) : Rt(t)),
      t
    );
  }
  async start(t = {}) {
    return (
      ...
      (this.context.startOptions = re(St, t)),
...
var Kt = /\.(js|jsx|ts|tsx|mjs|woff|woff2|ttf|otf|eot)$/,
  Jt = [
    "sb-common-assets",
    "node_modules",
    "node-modules",
  ...
  Qt = (e) => !!(Kt.test(e) || Jt.some((r) => e.includes(r))),
  Yt = (e) =>
...
const rr = {
    ...
    checkbox: {
      root: {
        className: [
          "peer cursor-pointer inline-flex relative select-none align-bottom w-[18px] h-[18px",
        ],
      },
      box: ({ props: e, context: t }) => ({
        className: w(
          "flex items-center justify-center",
          "border w-[18px] h-[18px] text-gray-600 rounded transition-colors duration-200",
          { "border-gray-300 bg-white": !t.checked },
          { "border-[#A1C441] bg-[#A1C441]": t.checked },
          {
      ...
      input: {
        className:
          "peer w-full h-full absolute top-0 left-0 z-10 p-0 m-0 opacity-0 rounded-md outline-none border-2 border-surface-200 appearance-none cursor-pointer",
      },
      icon: {
        className:
          "w-3 h-3 transition-all duration-200 text-white text-base dark:text-gray-900",
      },
    },
    dialog: {
      root: ({ state: e }) => ({
      ...
      content: { className: "bg-white rounded-2xl p-3" },
      closeButton: { className: "hidden" },
      transition: {
        timeout: { enter: 300, exit: 350 },
        classNames: {
        ...
        children: _.jsxDEV(
          Pe,
          {
            ...
            children: _.jsxDEV(
              ...
              {
                fileName:
                  "/Users/andrey/Documents/work/client_premia/.storybook/preview.tsx",
                lineNumber: 30,
                columnNumber: 9,
              },
              void 0
...
export { ve as Provider, Lr as default };
